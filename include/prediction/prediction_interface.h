...
struct PredictionConfigPath {
    std::string prediction_config_path;
};
...
public:
    ...
    static PredictionInterface *create_instance();

    virtual std::string get_version() = 0;
    virtual bool init(const PredictionConfigPath &prediction_config_path) = 0;
    virtual bool execute(ObstaclesInfo *obstacles_info, LaneInfo *lane_info,
                         std::string &debug_info) = 0;
